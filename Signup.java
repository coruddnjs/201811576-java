...
public class Signup extends JFrame{
	...
	JTextField PW_d = new JTextField(10);
	JTextField name_d = new JTextField(10);
	...
	public Signup() {
		...
		P1.setLocation(60, 200);
		P2.setLocation(110, 200);
		P3.setLocation(180, 200);
		P1.setSize(30,20);
		P2.setSize(50,20);
		P3.setSize(50,20);
		...
		das.setLocation(95, 200);
		das.setSize(50,20);
		das.setHorizontalAlignment(JLabel.LEFT);
		das1.setLocation(165, 200);
		das1.setSize(50,20);
